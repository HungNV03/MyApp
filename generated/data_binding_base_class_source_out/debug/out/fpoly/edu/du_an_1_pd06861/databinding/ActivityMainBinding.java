...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull FrameLayout flContent, @NonNull NavigationView nvView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.nvView;
      NavigationView nvView = ViewBindings.findChildViewById(rootView, id);
      if (nvView == null) {
        break missingId;
      }

      return new ActivityMainBinding((DrawerLayout) rootView, drawerLayout, flContent, nvView);
    }
