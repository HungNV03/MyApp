...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final CheckBox chkRememberPass;
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull CheckBox chkRememberPass, @NonNull TextInputEditText edPassword,
      @NonNull TextInputEditText edUsername) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.chkRememberPass = chkRememberPass;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.chkRememberPass;
      CheckBox chkRememberPass = ViewBindings.findChildViewById(rootView, id);
      if (chkRememberPass == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnLogin, chkRememberPass,
